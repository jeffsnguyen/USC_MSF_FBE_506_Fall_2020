...
rJPM <- diff(log(JPM$JPM.Adjusted))
...
In terms of Sharpe Ratio, FB has better risk-adjusted returns performance compared to JPM. +1 for FB
In terms of Sortino Ratio, FB also generates better risk-adjusted performance with more weighting on the downside risk. +1 for FB
